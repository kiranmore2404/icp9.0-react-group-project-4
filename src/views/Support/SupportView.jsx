...
const Support = () => {
  ...
  return (
    ...
    >
      ...
      <p className="text-lg text-gray-700 text-center max-w-2xl bg-white bg-opacity-70 p-4 rounded-lg">
      ...
      <div className="mt-6 bg-white bg-opacity-80 p-6 rounded-lg shadow-lg w-full max-w-2xl">
